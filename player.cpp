...
Player::Player(int _width, int _height, Direction _dir, QVector2D head, QVector2D tail, QVector3D _front_color, QVector3D _back_color)
    : width(_width)
    , height(_height)
...
void Player::addTile(QVector2D tile) {
